...
/*
In certain applications, particularly in the financial area, it is often
...
int main() {
    ...
    struct date n1 = {8, 8, 2004};
    struct date n2 = {22, 2, 2005};

    printf("%i %i\n", N(n2), N(n1));
    printf("The difference between n2 and n1 is:\n");
    printf("%i", N(n2) - N(n1));
